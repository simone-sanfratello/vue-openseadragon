/* v. 0.1.0 */
"use strict";Vue.component("vue-openseadragon",{template:'<div :id="id"></div>',props:{id:{type:String,default:"openseadradon-viewer"},options:{type:Object},i18n:{type:Object},messages:{default:{"Tooltips.FullPage":"","Tooltips.Home":"","Tooltips.ZoomIn":"","Tooltips.ZoomOut":"","Tooltips.NextPage":"","Tooltips.PreviousPage":"","Tooltips.RotateLeft":"","Tooltips.RotateRight":"","Errors.Dzc":"","Errors.Dzi":"","Errors.Xml":"","Errors.ImageFormat":"","Errors.Security":"","Errors.Status":"","Errors.OpenFailed":""}}},data:function(){return{viewer:null}},updated:function(){this.setup()},methods:{setup:function(){if(!this.viewer&&this.options){this.translate();const t=this.options;t.id=this.id,this.viewer=OpenSeadragon(t)}},resolve:function(t,e){try{const s=e.split(".");let o=t;for(const t of s)o=o[t];return o}catch(t){return null}},translate:function(){if(!this.i18n||!this.messages)return;const t=this.i18n.messages[this.i18n.locale];for(const e in this.messages)OpenSeadragon.setString(e,this.resolve(t,this.messages[e]))}}});//! openseadragon 2.3.1
//! Built on 2017-09-19
